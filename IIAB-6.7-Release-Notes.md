...
* The current menu must be loaded manually in the Admin Console by clicking the Load Menu button in Content Menus -> Edit Content Menus  <sub><sub>[#1513](https://github.com/iiab/iiab/issues/1513)</sub></sub>