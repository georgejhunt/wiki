...
* Installing IIAB over Wi-Fi will fail.  You will be forced to reboot, and re-run `sudo iiab`.  Then finally you will need to run `iiab-hotspot-on` after it finally auto-reboots at the end.  To avoid all these hassles, use Ethernet instead of WiFi to install IIAB.  <sub><sub>[#1519](https://github.com/iiab/iiab/issues/1519)</sub></sub> <sub><sub>[#1520](https://github.com/iiab/iiab/issues/1520)</sub></sub>