...
* Easily editable descriptions & logos on your community's IIAB home page (http://box).  <sub><sub>[#1002](https://github.com/iiab/iiab/issues/1002#issuecomment-462183401)</sub></sub>
  * Stronger [WordPress integration with IIAB](http://wiki.laptop.org/go/IIAB/FAQ#WordPress_.26_Moodle_Administration:_What_tips_.26_tricks_exist.3F) in general, with above descriptions/logos?
