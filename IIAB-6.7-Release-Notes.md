...
* IIAB's home page (http://box) will not display on Windows 7 running Internet Explorer 11.  Please install a modern browser e.g. Firefox or Chrome (js-menu requires a more recent version of JavaScript).  <sub><sub>[#1517](https://github.com/iiab/iiab/issues/1517)</sub></sub>