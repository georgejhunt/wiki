...
* Kolibri's systemd service times out (fails to start) during the 1st reboot of IIAB, on Ubuntu 18.04 and possible other OS's too.  Until this is better understood, a workaround is to run "systemctl start kolibri", or simply to reboot.  <sub><sub>[#1489](https://github.com/iiab/iiab/issues/1489)</sub></sub>
