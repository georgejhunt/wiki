...
* Kolibri's systemd sometimes service times out (fails to start) during the 1st reboot of IIAB, on Ubuntu 18.04 and possible other OS's too.  As of 2019-02-11, the workaround is to run "systemctl start kolibri" &mdash; or simply to reboot.  <sub><sub>[#1489](https://github.com/iiab/iiab/issues/1489)</sub></sub>
