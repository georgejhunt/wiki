...
* [Mosquitto (MQTT)](https://github.com/iiab/iiab/tree/master/roles/mosquitto) & [Node-RED](https://github.com/iiab/iiab/tree/master/roles/nodered) support for IoT (Internet of Things) electronics projects, with URL _box/nodered_  <sub><sub>[PR #1398](https://github.com/iiab/iiab/pull/1398)</sub></sub>
* [Minetest](https://github.com/iiab/iiab/tree/master/roles/minetest#minetest-readme) is an open source clone of [Minecraft](https://en.wikipedia.org/wiki/Minecraft), the creative/explorational building blocks game.  The Minetest server runs on Raspberry Pi only for now.  <sub><sun>[PR #1454](https://github.com/iiab/iiab/pull/1454)</sub></sun>
