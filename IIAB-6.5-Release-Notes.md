...
* Usage statistics of ZIM files (for teachers especially) are viewable with AWStats on your IIAB server at http://box/awstats/awstats.pl ([instructions](http://wiki.laptop.org/go/IIAB/FAQ#How_do_I_view_usage_statistics.3F)).  We've used an Apache proxy of Kiwix, hoping to empower teachers to understand their own community analytics.
