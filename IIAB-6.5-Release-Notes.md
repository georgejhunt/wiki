...
* Experimental support for Ubuntu 17.10, in preparation for Ubuntu 18.04 LTS expected 2017-04-26.
...
* Nextcloud is upgraded to [12.0.5](https://nextcloud.com/blog/12.0.5-and-11.0.7-are-out-time-to-upgrade/) &mdash; with [13.0.0](https://github.com/nextcloud/server/milestone/20) expected 2018-01-31. ([schedule](https://github.com/nextcloud/server/wiki/Maintenance-and-Release-Schedule))
...
* WordPress is upgraded to [4.9.2](https://wordpress.org/news/2018/01/wordpress-4-9-2-security-and-maintenance-release/) based on [4.9](https://wordpress.org/news/2017/11/tipton/) &mdash; with 4.9.3 expected 2018-01-30.
