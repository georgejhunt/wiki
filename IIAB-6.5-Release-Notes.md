...
* Automounting of USB memory sticks, SD cards and large disks (that are typically NTFS-formatted or exFAT-formatted when purchased) for (1) installation of offline content and (2) [so teachers can instantly display their own content](http://wiki.laptop.org/go/IIAB/FAQ#Can_teachers_display_their_own_content.3F) to students via http://box/usb
