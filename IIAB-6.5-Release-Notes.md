...
* Completely overhauled Calibre E-Book server [3.18+](https://calibre-ebook.com/whats-new) on Raspberry Pi: allows adding and deleting of books using the web interface (Internet-in-a-Box installs the very latest Calibre from Kovid Goyal).
