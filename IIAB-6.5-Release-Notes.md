...
* Admin Console -> Install Content -> Get ZIM Files from Kiwix now had tooltips (small popup windows) helping you drill down to the best downloadable ZIM content.
* RACHEL modules can now be downloaded/installed directly from [oer2go.org](http://oer2go.org) &mdash; using IIAB's Admin Console of the command line.  [#641](https://github.com/iiab/iiab/issues/641)
