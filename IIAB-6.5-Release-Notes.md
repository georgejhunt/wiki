...
* Apache proxy of Kiwix empowers community analytics (ZIM file usage statistics) are viewable with AWStats (at http://box/awstats/awstats.pl, [instructions](http://wiki.laptop.org/go/IIAB/FAQ#How_do_I_view_usage_statistics.3F)).
