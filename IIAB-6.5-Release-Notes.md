...
* Moodle is upgraded to [3.1.11](https://docs.moodle.org/dev/Category:Moodle_3.1) LTS (3.5 LTS [expected 2018-05-14](https://make.wordpress.org/core/2018/04/21/4-9-6-schedule/)).
