...
* Nextcloud is upgraded to [12.0.5](https://nextcloud.com/blog/nextcloud-12.0.4-is-here-time-to-upgrade/) &mdash; with [13.0.0](https://github.com/nextcloud/server/milestone/20) expected 2018-01-24. ([schedule](https://github.com/nextcloud/server/wiki/Maintenance-and-Release-Schedule))
