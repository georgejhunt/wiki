...
* Media-rich and searchable offline (ZIM) content thanks to an even far better and far more compact [Kiwix](http://www.kiwix.org/) engine 0.6.1 (2018-08-30) under the hood, with "iiab-make-kiwix-lib" now far more efficient at the command-line, _watch out Google here we come :-)_
