...
* Nextcloud is upgraded to [13.0.5](https://nextcloud.com/changelog/) based on [Nextcloud 13](https://nextcloud.com/blog/nextcloud-13-brings-secure-file-sync-and-collaboration-to-the-next-level/), bringing the [latest fixes](https://help.nextcloud.com/t/help-testing-12-0-10-rc-1-13-0-5-rc-2/33955).
...
* Calibre 3.27.1 (like 3.24.x and 3.25) prevent IIAB microSD's from booting in Raspberry Pi Zero W.  Those who rely on RPi Zero W need to turn off Calibre's installation in /etc/iiab/local_vars.yml for now.  [#952](https://github.com/iiab/iiab/issues/952)
