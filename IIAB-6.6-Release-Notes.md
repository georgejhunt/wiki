...
* Wikipedia's own MediaWiki 1.31.0 LTS is now part of [BIG-sized](http://wiki.laptop.org/go/IIAB/local_vars_big.yml) installs of IIAB, or if you enable it in [local_vars.yml](http://wiki.laptop.org/go/IIAB/local_vars.yml) (typically on Lines 143 and 144) for doc collaboration.
