...
* [Ubuntu 18.04](http://releases.ubuntu.com/18.04/) LTS on x86_64 _(WARNING: IIAB's [1-line installer](http://download.iiab.io) must be run as root!)_
...
* [Ubuntu Server 19.10.1 for Raspberry Pi](https://ubuntu.com/download/raspberry-pi) released 2019-12-05: stick with the 32-bit version for Kiwix support ([docs](https://wiki.ubuntu.com/ARM/RaspberryPi), [downloads](http://cdimage.ubuntu.com/releases/19.10.1/release/)).  Please do not install or enable Sugarizer in /etc/iiab/local_vars.yml as this OS lacks MongoDB.
