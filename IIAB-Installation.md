...
Here is the complete list of the steps required. Some may already be done.
   ...
   1. An Ethernet (live Internet) cable is currently **required** during installation!  Log into the machine locally or via ssh.  Verify your internet connection by typing:
