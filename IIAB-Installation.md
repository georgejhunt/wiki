...
Here is the complete list of the steps required. Some may already be done.
   ...
   1. _[Ansible 2.4.x is required on Debian and recommended on all OS's](https://github.com/iiab/iiab/issues/375#issuecomment-334500152) so that multiple runs of "./runansible" can complete.  Run "ansible --version" to make sure you don't have an older version installed.  If you do, run "apt purge ansible", prior to Ansible 2.4.x's installation below._
