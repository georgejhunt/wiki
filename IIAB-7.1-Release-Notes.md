...
- Coming Soon: [Captive Portal](http://wiki.laptop.org/go/IIAB/FAQ#Captive_Portal_Administration:_What_tips_.26_tricks_exist.3F) that actually works on substantially more client devices/browsers when Internet-in-a-Box (IIAB) is installed on Raspberry Pi.  <sub><sub>[#1182](https://github.com/iiab/iiab/issues/1182)</sub></sub>
...
- [Lokole 0.5.6](https://github.com/iiab/iiab/tree/master/roles/lokole#lokole-readme) ([changelog](https://github.com/ascoderu/opwen-webapp/releases)) email for rural communities, students and teachers, with URL _box/lokole_
