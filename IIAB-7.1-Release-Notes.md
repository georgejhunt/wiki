...
- Coming Soon: Experimental option to operate the Raspberry Pi Wi-Fi (1) as a hotspot _at the very same time that_ (2) it's also connected to an upstream Internet access point.  <sub><sub>[PR #2337](https://github.com/iiab/iiab/pull/2337)</sub></sub>
...
- [Kiwix 3.1.0](https://en.wikipedia.org/wiki/Kiwix) ([changelog](https://github.com/kiwix/kiwix-tools/blob/master/Changelog)) with URL _box/kiwix_
