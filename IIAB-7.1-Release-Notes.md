...
- Self-Clone your entire Internet-in-a-Box (IIAB) e.g. to an external microSD card, using IIAB's Admin Console: http://box.lan/admin -> Install Content -> Clone IIAB <sub><sub>[#2268](https://github.com/iiab/iiab/issues/2268)</sub></sub>
