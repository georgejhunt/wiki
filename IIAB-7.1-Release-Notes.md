...
- Choice of two OS's on Raspberry Pi ([Ubuntu 20.04 or Raspbian](https://github.com/iiab/iiab/wiki/IIAB-Platforms#operating-systems)).  Some prefer Ubuntu for its (1) more recent kernel support for Raspberry Pi hardware (2) potential for 32 simultaneous WiFi connections, instead of just 18 with Raspbian.  <sub><sub>[#823](https://github.com/iiab/iiab/issues/823)</sub></sub>
