...
* Beautify your IIAB home page (http://box) with new click-to-install logos for each of your Content Packs & Apps.  Rewrite any of their descriptions in your own language, also from IIAB's Admin Console (http://box.lan/admin) so students know exactly what's available to them, in their own language!
...
* [Kiwix 1.2.1 -> 1.2.2](https://github.com/kiwix/kiwix-tools/blob/master/Changelog) ETA May or June?  With URL _box/kiwix_  <sub><sub>[PR #1610](https://github.com/iiab/iiab/issues/1610)</sub></sub>
