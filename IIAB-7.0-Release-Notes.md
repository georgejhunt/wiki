...
* Update your IIAB's clock automatically even when it's offline, when nearby smartphones or laptops/devices browse to your IIAB.  This helps low-end Raspberry Pi servers that contain no RTC (real-time clock), so they don't completely lose track of the current day and time.  <sub><sub>[#1680](https://github.com/iiab/iiab/issues/1680)</sub></sub>
...
* [Lokole 0.4.4](https://github.com/iiab/iiab/tree/master/roles/lokole#lokole-readme) ([changelog](https://github.com/ascoderu/opwen-webapp/releases)) email for rural communities, students and teachers, with URL _box/lokole_
* [Moodle 3.5.7+ LTS](https://docs.moodle.org/dev/Moodle_3.5.7_release_notes) building on [3.5 LTS](https://docs.moodle.org/dev/Releases#Moodle_3.5_.28LTS.29), with URL _box/moodle_  <sub><sub>[#1658](https://github.com/iiab/iiab/issues/1658)</sub></sub>
