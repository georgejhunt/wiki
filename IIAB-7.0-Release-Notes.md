...
* [Nextcloud 15.0.7 -> 15.0.8 or 16.01](https://nextcloud.com/changelog/#latest15) ETA 2019-05-16, see [blog](https://nextcloud.com/blog/), with URL _box/nextcloud_  <sub><sub>[#1614](https://github.com/iiab/iiab/pull/1614)</sub></sub> <sub><sub>[#1649](https://github.com/iiab/iiab/issues/1649)</sub></sub>
...
* [Moodle 3.5.6 LTS](https://docs.moodle.org/dev/Moodle_3.5.6_release_notes) building on [3.5 LTS](https://docs.moodle.org/dev/Releases#Moodle_3.5_.28LTS.29), with URL _box/moodle_  <sub><sub>[#1528](https://github.com/iiab/iiab/issues/1528)</sub></sub>
