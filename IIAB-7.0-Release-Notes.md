...
* [Sugarizer 1.2.0](https://github.com/llaske/sugarizer/) with [Sugarizer Server 1.1.1](https://github.com/llaske/sugarizer-server/) ([changelog](https://github.com/llaske/sugarizer-server/blob/master/CHANGELOG.md)) with URL _box/sugarizer_  <sub><sub>[PR #1777](https://github.com/iiab/iiab/pull/1777)</sub></sub> <sub><sub>[PR #1966](https://github.com/iiab/iiab/pull/1966)</sub></sub>
