...
* Nearby smartphones and laptops/devices can update your IIAB's date and time automatically, simply by browsing to your IIAB home page (http://box).  This helps low-end Raspberry Pi servers that contain no RTC (i.e. real-time clock and coin cell battery), so they don't completely lose track of the current day and time.  <sub><sub>[#1680](https://github.com/iiab/iiab/issues/1680)</sub></sub>
