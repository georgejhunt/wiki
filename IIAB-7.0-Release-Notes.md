...
* Fix the date and time in your Internet-in-a-Box automatically, when a nearby smartphone visits your IIAB home page (http://box).  ETA May or June 2019.  <sub><sub>[PR iiab/iiab-admin-console#204](https://github.com/iiab/iiab-admin-console/pull/1579)</sub></sub>
* New commands like `iiab-diagnostics` for OpenVPN and your IIAB's firewall (iptables) can speed up remote support by 10X in many situations.  <sub><sub>[#1575](https://github.com/iiab/iiab/issues/1575)</sub></sub> <sub><sub>[PR #1654](https://github.com/iiab/iiab/pull/1654)</sub></sub> <sub><sub>[PR #1677](https://github.com/iiab/iiab/pull/1677)</sub></sub>
