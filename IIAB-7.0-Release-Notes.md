...
* Click the logo you want for individual Content Packs & Apps on your IIAB home page (http://box.lan).  Rewrite any of their descriptions in your own language, also from IIAB's Admin Console (http://box.lan/admin).
...
* [Moodle 3.5.6 LTS](https://docs.moodle.org/dev/Moodle_3.5.6_release_notes) ETA 2019-05-13, building on [3.5 LTS](https://docs.moodle.org/dev/Releases#Moodle_3.5_.28LTS.29), with URL _box/moodle_  <sub><sub>[#1528](https://github.com/iiab/iiab/issues/1528)</sub></sub>
