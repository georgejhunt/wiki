...
* Fix the date and time in your Internet-in-a-Box automatically, when a nearby smartphone visits your IIAB home page (http://box)  <sub><sub>[PR iiab/iiab-admin-console#204](https://github.com/iiab/iiab-admin-console/pull/1579)</sub></sub>
