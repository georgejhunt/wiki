...
* New commands like `iiab-diagnostics` will speed up remote support by 10X in many situations.  <sub><sub>[#1575](https://github.com/iiab/iiab/issues/1575)</sub></sub> <sub><sub>[PR #1596](https://github.com/iiab/iiab/pull/1596)</sub></sub>
...
* For a more detailed list, see: https://github.com/iiab/iiab/milestone/6
