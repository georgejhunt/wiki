...
* [Nextcloud 17.0.0+](https://nextcloud.com/changelog/#latest17) ([blog](https://nextcloud.com/blog/)) with URL _box/nextcloud_  <sub><sub>[#1957](https://github.com/iiab/iiab/issues/1957)</sub></sub>
...
* [Kiwix 3.0.1-5](https://en.wikipedia.org/wiki/Kiwix) ([changelog](https://github.com/kiwix/kiwix-tools/blob/master/Changelog)) with URL _box/kiwix_  <sub><sub>[PR #1909](https://github.com/iiab/iiab/pull/1909)</sub></sub>
...
* [Calibre 3.48+](https://calibre-ebook.com/whats-new) (Raspbian 3.47.1+ on Raspberry Pi) with URL _box:8080_
* [Sugarizer 1.2.0](https://github.com/llaske/sugarizer/) ([changelog](https://github.com/llaske/sugarizer/blob/master/CHANGELOG.md#120---2019-09-26)) with [Sugarizer Server 1.1.1](https://github.com/llaske/sugarizer-server/) ([changelog](https://github.com/llaske/sugarizer-server/blob/master/CHANGELOG.md#111---2019-07-30)) with URL _box/sugarizer_  <sub><sub>[PR #1777](https://github.com/iiab/iiab/pull/1777)</sub></sub> <sub><sub>[PR #1966](https://github.com/iiab/iiab/pull/1966)</sub></sub>
