...
* [Gitea 1.8.1](https://github.com/iiab/iiab/tree/master/roles/gitea#gitea-readme) lightweight self-hosted "GitHub", with URL _box/gitea_  <sub><sub>[PR #1242](https://github.com/iiab/iiab/pull/1242)</sub></sub>  (Might require that we revert to 1.7.6 for Raspberry Pi?)  <sub><sub>[#1673](https://github.com/iiab/iiab/issues/1673)</sub></sub>
