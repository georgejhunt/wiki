...
* [Moodle 3.5.6 LTS](https://docs.moodle.org/dev/Moodle_3.5.6_release_notes) (or possibly [Moodle 3.5.7 LTS](https://docs.moodle.org/dev/Moodle_3.5.7_release_notes)) building on [3.5 LTS](https://docs.moodle.org/dev/Releases#Moodle_3.5_.28LTS.29), with URL _box/moodle_  <sub><sub>[#1529](https://github.com/iiab/iiab/issues/1529)</sub></sub> <sub><sub>[#1658](https://github.com/iiab/iiab/issues/1658)</sub></sub>
...
* [MediaWiki 1.33.0](https://mediawiki.org/wiki/Release_notes/1.33) with URL _box/mediawiki_
