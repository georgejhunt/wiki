...
* Kolibri blocks you from logging in at times, with the login page infinitely/rapidly looping.  Deleting your browser's cookies AND all of its stored state seems to help.  <sub><sub>[#1775](https://github.com/iiab/iiab/issues/1532)</sub></sub>
