...
* Map Packs cause Chrome and Firefox browsers to crash on many mobile and low-memory devices.  <sub><sub>[#1728](https://github.com/iiab/iiab/issues/1728)</sub></sub>
