...
Internet-in-a-Box (IIAB) runs on various GNU/Linux operating systems such as Raspbian, Ubuntu, Debian &mdash; and possibly also on CentOS, Fedora and Ubermix if you [invest the effort](https://github.com/iiab/iiab/wiki/IIAB-Platforms#operating-systems)!
