...
* A major house cleaning after 2 years, deprecating unmaintained server apps, so IIAB installs faster and is more understandable.  This also brings tighter [default_vars.yml](https://github.com/iiab/iiab/blob/master/vars/default_vars.yml) system-wide defaults.
