...
* Nextcloud (http://box/nextcloud) sometimes takes far too long to login/logout on RPi3 (more than a minute, instead of the usual ~2 seconds).  If this affects you, please help everyone try to isolate the pattern, by posting to [#401](https://github.com/iiab/iiab/issues/401) so that an upstream bug can be filed towards resolution!
