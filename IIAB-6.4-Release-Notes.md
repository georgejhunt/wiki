...
* IIAB 6.4 does not install on Raspbian Stretch With Desktop.  Please instead use Raspbian Stretch Lite, or manually implement fix [#399](https://github.com/iiab/iiab/pull/399/files) from our [IIAB 6.5](http://download.iiab.io/6.5/rpi/) pre-releases.
