...
* Support for [Raspbian Stretch](https://www.raspberrypi.org/blog/raspbian-stretch/) and [Debian 9.1](https://www.debian.org/News/2017/20170722) (and possibly soon Debian 9.2) guaranteeing a solid LTS (long-term support) foundation for years to come.
...
* WordPress upgraded to [4.8.1](https://core.trac.wordpress.org/milestone/4.8.1).
* Nextcloud upgraded to [12.0.2](https://nextcloud.com/changelog/).
* Sugarizer upgraded to [0.9](http://lists.sugarlabs.org/archive/iaep/2017-September/020080.html).
